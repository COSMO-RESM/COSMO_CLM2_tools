...
** Remove imput files after each chunck
** Start with transfer job instead of transfer from login nodes
   At least as an option.
** TODO CESM date settings
   Document changes about stop_option and calendar parameters in the
   drv_in namelist
** TODO OASIS restarts
