...
* Usage
  ...
  #+BEGIN_SRC text
    ...
    optional arguments:
      ...
      --run_length dt       sets simulation length if end_date not specified or run lengthbetween restarts otherwisedt is of the form 'N1yN2m' or 'N1y' or 'N2m' or 'N3d'N1, N2 and N3 being arbitrary integers (N2>12 posible) and'y', 'm' and 'd' stand for year, month and day
